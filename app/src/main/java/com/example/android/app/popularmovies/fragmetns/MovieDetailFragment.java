...
public class MovieDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (intent != null && intent.hasExtra(PopularMovieConstants.MOVIE_DATA)) {
            ...
            ((TextView) rootView.findViewById(R.id.movieTitle)).setText(movieDetails.getOriginal_title());
            ((TextView) rootView.findViewById(R.id.rating)).setText(Float.toString(movieDetails.getVote_average()));
            ((TextView) rootView.findViewById(R.id.description)).setText(movieDetails.getOverview());
           ...
           /* Picasso.with(getContext())
                    .load("http://image.tmdb.org/t/p/w185/" + movieDetails.getBackdrop_path())
                    .into((ImageView) rootView.findViewById(R.id.BackdropimageView)
                    );*/
        }
