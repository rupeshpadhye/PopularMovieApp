...
public class MovieDetailActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new MovieDetailFragment(), getString(R.string.details));
        adapter.addFragment(new MovieReviewFragment(), getString(R.string.reviews));
        adapter.addFragment(new MovieTrailerFragment(), getString(R.string.trailers));
